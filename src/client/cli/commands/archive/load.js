...
module.exports = {
  ...
  description: 'Load an archive (generated by `mcclient archive dump`) into the local node.\n',
  builder: {
    filename: {
      description: 'A tar archive (optionally gzipped) from which to read statements and objects, ' +
        'as generated by `mcclient archive dump`.  If not given, archive will be read from standard input.\n',
      required: false,
      type: 'string',
      default: null
    },
